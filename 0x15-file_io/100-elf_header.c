 ...
 * @e_ident: A pointer to an array of magic numbers.
 */
void print_magic_numbers(unsigned char *e_ident)
{
int i;
 ...
 * @e_ident: A pointer to an array of class.
 */
void print_class(unsigned char *e_ident)
{
printf("  Class:                             ");
 ...
 * @e_ident: A pointer to an array of version.
 */
void print_version(unsigned char *e_ident)
{
printf("  Version:                           %d",
 ...
 * @e_ident: A pointer to an array of ABI version.
 */
void print_abi(unsigned char *e_ident)
{
